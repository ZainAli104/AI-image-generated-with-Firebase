  ...
  const generateImage = async () => {
    if (form.prompt) {
      try {
        ...
        // const response = await fetch('https://ai-image-generated-with-firebase.vercel.app/api/v1/dalle', {
          method: 'POST',
          headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    if (form.prompt) {
      ...
      try {
        ...
        // const response = await fetch('https://ai-image-generated-with-firebase.vercel.app/api/v1/post', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
          ...
          <div className='relative bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-64 p-3 h-64 flex justify-center items-center'>
            {form.photo ? (
              ...
              <img 
                src={preview}
                alt='preview'
                className='w-9/8 h-9/8 object-contain opacity-40'
              />
            )}
